...
void DEMO_Render(double deltatime)
{
	...
	draw_maze(walls, flor, ceiling, floorlites, ceilinglites, buffer, xview, yview, viewing_angle, viewer_height, ambient_level, image, litetable, litelevel);
}
